...
class Mage_Core_Test_Helper_File_Storage extends Mage_Test_Unit_Case
{
    /**
    ...
    const CLASS_ID = 'core/helper_file_storage';

    protected function setUp()
    {
        $this->_model = new Mage_Core_Helper_File_Storage();
    }
    ...
    public function testIsInternalStorage()
    {
        $this->markTestIncomplete('This test has not been implemented yet.');
    }  
    ...
    public function testProcessStorageFile()
    {
        $this->markTestIncomplete('This test has not been implemented yet.');
    }  
